sap.ui.define([
    ...
    return Controller.extend("saida2.controller.BaseController", {
        /**
            ...
            oDisponibilidadeBinding.requestContexts(0, 1).then(function(aContexts) {
                if (aContexts && aContexts.length > 0) {
                    ...
                    oDisponibilidadeModel.setData({
                        ...
                        LugaresMotoTotal: oDisponibilidade.LugaresMotoTotal || oCurrentData.LugaresMotoTotal || 20,
                        LugaresLigeiroTotal: oDisponibilidade.LugaresLigeiroTotal || oCurrentData.LugaresLigeiroTotal || 65,
                        LugaresPesadoTotal: oDisponibilidade.LugaresPesadoTotal || oCurrentData.LugaresPesadoTotal || 15
                    });
